...
public class HistoriqueClub {
    ...
    public HistoriqueClub(int idJoueur, String nomClub, java.sql.Date saisonDebut, java.sql.Date saisonFin) {
    ...
    public HistoriqueClub(int idHistorique, int idJoueur, String nomClub, java.sql.Date saisonDebut, java.sql.Date saisonFin) {
